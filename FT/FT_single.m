...
%---------------------------------------------------------
function SMresult = FT_single(imgfile) %CVBIOUC%
%CVBIOUC% img = imread('input_image.jpg');%Provide input image path
img = imread(imgfile); %CVBIOUC%
gfrgb = imfilter(img, fspecial('gaussian', 3, 3), 'symmetric', 'conv');
%---------------------------------------------------------
% Perform sRGB to CIE Lab color space conversion (using D65)
%---------------------------------------------------------
%CVBIOUC% cform = makecform('srgb2lab', 'whitepoint', whitepoint('d65'));
cform = makecform('srgb2lab', 'AdaptedWhitePoint', whitepoint('d65')); %CVBIOUC%
